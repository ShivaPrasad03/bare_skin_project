    ...
    return ( <div>
        ...
        <nav>
          ...
          <div className='navbar-menu'>
            ...
            <Link to="/appointment"><button className='appointment-btn '>Book Appointment</button></Link>
          </div>
        </nav>
        <div className='intro'>
           ...
           <div className='service-list'>
                    <div className='service-card' >
                      <div>
                          ...
                          <Link to='/appointment'><button className='appointment-btn service-card-div-button'>Book Appointment</button></Link>
                        </div> 
