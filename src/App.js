...
class App extends Component{
  ...
  render(){
         ...
         const change = this.state.bool;
    return ( <div>
        <nav>
          <img src={img} alt='logo'  className='logo' />
          <div className='navbar-menu'>
            { this.state.bool && <Modal change = {this.toggle}/>}
            <a href='/' className='navbar-menu-a apt-btn'><p>Home</p></a>
            <a href='#services' className='navbar-menu-a apt-btn'><p>Services</p></a>
            <a href='#contact' className='navbar-menu-a apt-btn'><p>Contact</p></a>
            <button className='appointment-btn ' onClick={this.toggle}>Book Appointment</button>
          </div>
        </nav>
        <div className='intro'>
           ...
           <div className='service-list'>
                    <div className='service-card' >
                      <div>
                          ...
                          <button className='appointment-btn service-card-div-button' onClick={this.toggle} >Book Appointment</button>
                        </div> 
                    ...
                    <div>
                      ...
                      <img src='https://img.freepik.com/free-photo/specialist-doing-face-procedure-with-instrument_1098-21234.jpg?size=626&ext=jpg&ga=GA1.2.1139177812.1679995113&semt=ais' alt=''/>
                    </div>
                  ...
                  <div className='service-card'>
                    ...
                    <div className='service-card'>
                      ...
                      <img src='https://img.freepik.com/premium-photo/body-care-underarm-laser-hair-removal_98890-141.jpg?w=900' alt=' '/>
                    </div>
        ...
        <div className='contact contact-first-card' id='contact'>
          ...
          <div className='contact-second-card'>
            <p><i class="fa-regular fa-copyright"></i> BareSkinLaser All rights reserverd </p>
          </div>
